...
escriba un rectángulo con ese tamaño formado por su nombre. Esta versión 
utiliza una funcion*/
...
class Ej03a
{
    static void writeSquare(string name, int rows, int colums)
    {
