...
{
    struct datoContable : IComparable
    {
        public string fecha;
        ...
        public int CompareTo(object otro)
        {
            ...
            int comparaCFechas = fecha.CompareTo(((datoContable)otro).fecha);
            if (comparaCFechas != 0)
                return comparaCFechas;

            int comparacDescripc = descripcion.CompareTo(((datoContable)otro).descripcion);
